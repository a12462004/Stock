	...
	if(code == undefined){ //若為undefined代表沒有輸入code，直接跳轉頁面到CompanyProfile的1101
		...
		new sql.ConnectionPool(db).connect().then(pool => {
    		...
    		let rows = result.recordset
				...
				res.render('./PBR', {title: '股起勇氣', data: rows });
			}
  			}).catch(err => {
